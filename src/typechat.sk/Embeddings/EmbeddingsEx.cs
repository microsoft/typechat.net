...
public static class EmbeddingsEx
{
    ...
    [Obsolete("Use Task<Embedding<float>> GenerateEmbeddingAsync(this IEmbeddingGenerator<string, Embedding<float>> model, string text, Kernel kernel, CancellationToken cancelToken = default) instead. ")]
